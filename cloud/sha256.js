...
(function(H) {
    function v(c, a, b) {
        ...
        r = function(a, b, f, d) {
            var g, e;
            if ("SHA-224" === c || "SHA-256" === c) g = (b + 65 >>> 9 << 4) + 15,
            e = 16;
        ...
        this.setHMACKey = function(a, b, d) {
            ...
            for (a = 0; a <= d; a += 1) q[a] = b[a] ^ 909522486,
            t[a] = b[a] ^ 1549556828;
            h = F(q, h);
            g = m;
            k = !0
    ...
    function J(c, a, b) {
        ...
        b = b || 0;
        f = b >>> 3;
        for (d = 0; d < c.length; d += 1) a = c.charCodeAt(d),
        h = d + f,
        e = h >>> 2,
        g.length <= e && g.push(0),
        g[e] |= a << 8 * (3 - h % 4);
    ...
    function K(c, a, b) {
        ...
        for (e = 0; e < c.length; e += 4) {
            l = c.substr(e, 4);
            for (h = n = 0; h < l.length; h += 1) f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(l[h]),
            n |= f << 18 - 6 * h;
    ...
    function C(c, a) {
        ...
        g = 4 * c.length,
        d, f;
        for (d = 0; d < g; d += 1) f = c[d >>> 2] >>> 8 * (3 - d % 4),
    ...
    function E(c) {
        ...
        b = 4 * c.length,
        g, d;
        for (g = 0; g < b; g += 1) d = c[g >>> 2] >>> 8 * (3 - g % 4) & 255,
    ...
    function z(c, a) {
        ...
        case "TEXT":
            b = function(b, c, f) {
                ...
                c = f || 0;
                k = c >>> 3;
                if ("UTF8" === a) for (l = 0; l < b.length; l += 1) for (f = b.charCodeAt(l), h = [], 128 > f ? h.push(f) : 2048 > f ? (h.push(192 | f >>> 6), h.push(128 | f & 63)) : 55296 > f || 57344 <= f ? h.push(224 | f >>> 12, 128 | f >>> 6 & 63, 128 | f & 63) : (l += 1, f = 65536 + ((f & 1023) << 10 | b.charCodeAt(l) & 1023), h.push(240 | f >>> 18, 128 | f >>> 12 & 63, 128 | f >>> 6 & 63, 128 | f & 63)), m = 0; m < h.length; m += 1) {
                    p = n + k;
    ...
    function A(c, a, b) {
        ...
        n = a[6];
        l = a[7];
        for (p = 0; p < r; p += 1) 16 > p ? (k = p * t, m = c.length <= k ? 0 : c[k], k = c.length <= k + 1 ? 0 : c[k + 1], x[p] = new D(m, k)) : x[p] = v(w(x[p - 2]), x[p - 7], y(x[p - 15]), x[p - 16]),
        m = u(l, A(e), B(e, h, n), E[p], x[p]),
        k = q(z(b), C(b, g, d)),
        l = n,
        n = h,
        h = e,
